...
(function(root, factory) {
    ...
    function handleTweets(tweets) {
        if (customCallbackFunction === null) {
            ...
            var html = '<div id="twitterblock"><div class="row">';
            while (n < x) {
                html += '<div class="span6" style="position:relative">' + tweets[n] + '</div>';
                n++;
            }
            html += '</div></div>';
            ...
            if (dataOnly) {
                ...
                while (n < x) {
                    ...
                    if (parseLinks) {
                        ...
                        op += '<div class="tweet"><a href="' + permalinksURL[n] + '">' + strip(tweets[n].innerHTML) + '</a></div><div class="user"><h4>' + strip(authors[n].innerHTML) + '</h4></div>';
                    }
